...
sensorRes = [ Camera.pixelPitch, Camera.pixelPitch]./Camera.superResFactor;
...
Resolution.spacingPixels=Camera.spacingPixels;
Resolution.coordi=Camera.coordi;
Resolution.view_num=Camera.view_num;
